...
// Define the type for a turf field
interface TurfField {
  id: number;
  name: string;
  location: string;
      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {turfFields.map((field) => (
            <div key={field.id} className="bg-white rounded-lg overflow-hidden shadow-md hover:shadow-xl transition-shadow duration-300">
              {/* Field Image */}
